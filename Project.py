    #This file for doumentation barnch
import time
import pandas as pd
import numpy as np
...
def get_filters():
    ...
    while True:    
        month = input("what month(s) do you want to filter data?, type month name from within first six months or type 'all' for all months : " )
        month = month.lower()
    ...
    while True:
        day = input("what day(s) do you want to filter data?, type the day name or type 'all' for all days : " )
        day = day.lower()
...
def load_data(city, month, day):
    ...
    """
     # load data file into a dataframe df = pd.read_csv(filename)
